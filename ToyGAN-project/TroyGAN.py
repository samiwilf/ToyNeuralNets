...
#What's interesting is that in many GAN solutions, the generator's input is noise that doesn't bear an recognizable relationship to the generator's output.
