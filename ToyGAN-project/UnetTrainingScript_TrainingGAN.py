...
"""
NOTE TO SELF!!!!! MAKE TWO SEPARATE PROGRAMS!!! ONE TRAINS GENERATOR. OTHER THE DISCRIMINTAOR....


I NEED THE TRAINING SAMPLE GENERATOR TO ALTERNATE BETWEEN FORCED 0 AND FORCED 1 OUTPUT.

FREEZE DISCRIMINATOR TO TRAIN GENERATOR, AND FORCE Y_TRUE TO ALWAYS BE 1.
FREEZE GENERATOR TO TRAIN DISCRIMINATOR, AND FORCE Y_TRUE TO ALWAYS BE 0. 


TO TRAIN DISCRIMINATE, GET PREDICTED OUTPUT OF GEN. THEN TRAIN DISCRIMINATOR WITH Y_TRUE SET TO FALSE.
